...
int consume_action(game *g, int who)
{
	 ...
	 * transcripts refute -- base-game tables 881507279, 891077035 and
	 * 900911298 all end a Consume phase by walking away from a lone
	 * Gambling World lucky.  This matches rftg2's engine, which asks
	 * unconditionally and reports exactly this flag. */
